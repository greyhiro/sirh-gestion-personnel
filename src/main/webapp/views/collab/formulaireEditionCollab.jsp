...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-4">
				<img src="http://localhost:8081/sgp/image/okami_232697.jpg"
				...
				<div id="accordion">
						...
						<div id="collapseOne" class="collapse show"
							...
							<div class="card-body">
								<form class="needs-validation" METHOD="POST" novalidate
									action="http://localhost:8081/sgp/collaborateurs/editer">
									<div class="row">
										...
										<div class="form-group row col-sm-12 col-md-12 col-lg-10 ">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="Nom" name="nom"
													placeholder="Nom">
												<div class="invalid-feedback">Il vous faut ecrire un
													nom</div>
										...
										<div class="form-group row col-sm-12 col-md-12 col-lg-10 ">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control"
													id="Date_de_naissance" name="dateDeNaissance" placeholder="date de naissance">
												<div class="invalid-feedback">Il vous faut ecrire une
													date de naissance au format jj/mm/yyyy</div>
												<div class="valid-feedback">valide</div>
											</div>
										</div>
										...
										<div class="form-group row col-sm-12 col-md-12 col-lg-10 ">
											...
											<div class="col-sm-10">
												<input type="text-area" class="form-control" id="Adresse" name="adresse"
													placeholder="Adresse">
										...
										<div class="form-group row col-sm-12 col-md-12 col-lg-10 ">
											...
											<div class="col-sm-10">
												<input type="text-area" class="form-control" id="email" name="email"
													placeholder="Adresse">
												<div class="invalid-feedback">adresse invalide</div>
												<div class="valid-feedback">valide</div>
											</div>
										...
										<div class="form-group row col-sm-12 col-md-12 col-lg-10 ">
											...
											<div class="form-group row col-sm-12 col-md-12 col-lg-10 ">
											<label for="numSecu" class="col-sm-2 col-form-label">Photo</label>
											<div class="col-sm-10">
												<input type="text" class="form-control" id="photo" name="photo"
													placeholder="lien photo">
												<div class="invalid-feedback">photo
													invalide</div>
												<div class="valid-feedback">valide</div>
											</div>
										</div>
					...
					<div class="card">
						<div class="card-header" id="headingThree">
							<h5 class="mb-0">
								<button class="btn btn-link collapsed" data-toggle="collapse"
									...
									aria-controls="collapseThree">Coordonée bancaire</button>
							</h5>
						</div>
						<div id="collapseThree" class="collapse"
							...
							<div class="card-body">
								<div
									class="form-group row col-sm-12 col-md-12 col-lg-10 offset-1">
			...
			<div class="col">
				...
				<button type="button" class="btn-primary btn-sm float-left"
					onclick="window.location.href='http://localhost:8081/sgp/index.jsp'">retour
					a l'acceuil</button>
